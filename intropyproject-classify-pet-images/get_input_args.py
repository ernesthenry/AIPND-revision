...
#     2. CNN Model Architecture as --arch with default value 'vgg' (choices: vgg, alexnet, resnet)
...
def get_input_args():
    ...
    # Create 3 command line arguments with explicit choices for model architectures
